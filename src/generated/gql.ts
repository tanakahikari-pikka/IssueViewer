...
const documents = {
  ...
  "query GetRepositoryIssues($repoId: [ID!]!) {\n  nodes(ids: $repoId) {\n    ... on Repository {\n      id\n      name\n      issues(first: 10) {\n        edges {\n          node {\n            title\n          }\n        }\n      }\n    }\n  }\n}":
...
export function graphql(
  source: "query SearchRepositories($query: String!, $cursor: String) {\n  search(query: $query, type: REPOSITORY, first: 15, after: $cursor) {\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n    edges {\n      node {\n        ... on Repository {\n          id\n          name\n          description\n          languages(first: 5) {\n            edges {\n              node {\n                name\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n}"
): typeof documents["query SearchRepositories($query: String!, $cursor: String) {\n  search(query: $query, type: REPOSITORY, first: 15, after: $cursor) {\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n    edges {\n      node {\n        ... on Repository {\n          id\n          name\n          description\n          languages(first: 5) {\n            edges {\n              node {\n                name\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query GetRepositoryIssues($repoId: [ID!]!) {\n  nodes(ids: $repoId) {\n    ... on Repository {\n      id\n      name\n      issues(first: 10) {\n        edges {\n          node {\n            title\n          }\n        }\n      }\n    }\n  }\n}"
): typeof documents["query GetRepositoryIssues($repoId: [ID!]!) {\n  nodes(ids: $repoId) {\n    ... on Repository {\n      id\n      name\n      issues(first: 10) {\n        edges {\n          node {\n            title\n          }\n        }\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query SearchMyRepositories($query: String!, $cursor: String) {\n  search(query: $query, type: REPOSITORY, first: 15, after: $cursor) {\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n    edges {\n      node {\n        ... on Repository {\n          name\n          id\n          name\n          description\n          languages(first: 5) {\n            edges {\n              node {\n                name\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n}"
